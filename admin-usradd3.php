...
function confirmUser ($_POST)
{
	...
	$confirmUser ="
        ...
        <tr><th>Field</th><th colspan=2>Value</th></tr>
        <tr bgcolor='".TMPL_tblDataColor2."'><td>Username</td><td colspan=2>$username</td>
        <tr bgcolor='".TMPL_tblDataColor1."'><td>Password</td><td colspan=2>*</td>
        <tr><td colspan=3><br></td></tr>
        <tr><th>Select user Permissions </th><th>AND/OR</th><th>&nbsp;&nbsp;Select Department</th></tr>
        <tr><td>
        <table width=100%>";
        // list scripts
        db_connect();
