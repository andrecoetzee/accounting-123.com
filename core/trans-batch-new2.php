...
/*refnum*/
		...
		<tr class='bg-odd'><td>Select Account</td>
                <td valign=center>
                <select name='maccid'>";
                core_connect();
        		...
        		$view .="</select></td></tr>
		<tr class='bg-even'><td>Transaction</td><td><input type=radio name=tran value=dt checked=yes> Debit <input type=radio name=tran value=dt>Credit</td></tr>
		<tr class='bg-odd'><td>Number Of Contrast Accounts</td><td><input type=text size=5 name=noacc value='1'></td></tr>
		<tr><td><br></td></tr>
