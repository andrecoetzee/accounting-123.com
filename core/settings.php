...
if(!($_SESSION["USER_NAME"] == 'Root' || $_SESSION["USER_NAME"] == 'Admin' || basename (getenv ("SCRIPT_NAME")) == "acc-new.php" || basename (getenv ("SCRIPT_NAME")) == "main.php" || basename (getenv ("SCRIPT_NAME")) == "index.php" ||basename (getenv ("SCRIPT_NAME")) == "bottom_menu.php")){
        # check permission
        $chk = "SELECT * FROM userscripts WHERE username = '$_SESSION[USER_NAME]' AND script ='".rtrim(basename (getenv ("SCRIPT_NAME")))."'";
