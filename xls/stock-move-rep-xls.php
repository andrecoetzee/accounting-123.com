...
function printStk ($HTTP_POST_VARS)
{
	...
	<tr bgcolor='".TMPL_tblDataColor2."'><td colspan=2><b>Totals</b></td><td align=right>$totpqty</td><td align=right>$totqty</td><td align=right>".CUR." $totcsprice</td><td align=right>".CUR." $totprof</td></tr>
	</table>
	  ";
