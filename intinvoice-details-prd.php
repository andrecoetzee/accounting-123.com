...
/* --- End Some calculations --- */
	...
	<tr><td valign=top>
		...
		<table cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."' border=0>
			...
			<tr bgcolor='".TMPL_tblDataColor2."'><td>Invoice No.</td><td valign=center>$inv[invnum]</td></tr>
			...
			<tr bgcolor='".TMPL_tblDataColor1."'><td>Delivery Charge</td><td valign=center>$inv[delchrg]</td></tr>
		</table>
	</td></tr>
	<tr><td><br></td></tr>
	<tr><td colspan=2>
