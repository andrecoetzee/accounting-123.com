...
function enter ()
{
	...
	<tr bgcolor='".TMPL_tblDataColor2."'><td>".REQ."Document type</td><td><input type=text size=20 name=typename></td></tr>
...
function write ($_POST)
{
	...
	if (pg_cmdtuples ($catRslt) < 1) {
		return "<li class=err>Unable to add $typename to database.</li>";
	}
