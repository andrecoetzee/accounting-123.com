...
function newAccount() {
	...
	<form method='POST' action='newaccount.php'>
		...
		<tr>
			<th colspan='2' width=150>General</th>
		</tr>
		<tr class='even'>
			<td width=150>
				Account owner:
		...
		<tr>
			<th colspan='2' width=150>POP3</th>
		</tr>
		<tr class='even'>
			<td width=150>
				Server:
		...
		<tr>
			<th colspan='2' width=150>SMTP</th>
		</tr>
		<tr class='even'>
			<td width=150>
				Enabled:
...
function writeAccount() {
	...
	db_conn("cubit");
	$sql = "SELECT min(folder_id) FROM mail_folders";
	$rslt = db_exec($sql) or errDie("No folders found.");
	$fid = pg_fetch_result($rslt, 0);

	header("Location: messages.php?print=1&fid=$fid");
