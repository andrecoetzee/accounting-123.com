...
function seltoken() {
	...
	if(pg_numrows($Ry)<1) {
		$teamlinks="<tr><td>There are no links for this team. Select links under settings, view teams.</td></tr><tr><th>Quick Links</th></tr>
                <tr bgcolor='".TMPL_tblDataColor1."'><td align=center><a href='team-links.php?id=$crmdata[teamid]'>Select Team Links</a></td></tr>";
	} else {
		$teamlinks="";
...
function manage($HTTP_POST_VARS,$Notes="") {
	...
	<tr>
		...
		<tr><td><br></td></tr>
		<tr><th>Quick Links</th></tr>
		<tr bgcolor='".TMPL_tblDataColor2."'><td align='center'><a href='team-links.php?id=$crmdata[teamid]'>Team Links</a></td></tr>
		<tr bgcolor='".TMPL_tblDataColor1."'><td align=center><a href='tokens-manage.php'>Manage Queries</a></td></tr>
		...
		<td valign=top>
		<table border=0 cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."'>
		<tr bgcolor='".TMPL_tblDataColor1."'><th>Query Team</th><td>$qteams</td></tr>
		<tr bgcolor='".TMPL_tblDataColor2."'><th>Query Category</th><td>$cats</td></tr>
		<tr bgcolor='".TMPL_tblDataColor1."'><th>SUBJECT/SUMMARY:</th><td><input size=30 type=text name=sub value='$tokendata[sub]'></td></tr>
		<tr><th colspan=2>Query Notes</th></tr>
		<tr bgcolor='".TMPL_tblDataColor2."'><td colspan=2><textarea cols=50 rows=3 name=notes>$tokendata[notes]</textarea></td></tr>
		...
		<tr bgcolor='".TMPL_tblDataColor1."'><td>$actions</td><td><input type=text size=20 name=oaction></td></tr>
		</table>
		</td>
	...
	<tr>
		...
		<tr bgcolor='".TMPL_tblDataColor1."'><td><input type=button value='Send Message to User &raquo;' onclick='openwindow(\"message-send.php?id=$id\")'></td></tr>
		<tr bgcolor='".TMPL_tblDataColor2."'><td><input type=button value='Send E-Mail &raquo;' onclick='openwindow(\"email-send.php?id=$id\")'></td></tr>
		<tr bgcolor='".TMPL_tblDataColor1."'><td><input type=button value='Send SMS &raquo;' onclick='openwindow(\"https_face.php?target=sms-send.php?id=$id\")'></td></tr>
		<tr bgcolor='".TMPL_tblDataColor1."'><td><input type=button value='Forward to Future Date &raquo;' onclick='openwindow(\"tokens-forward.php?id=$id\")'></td></tr>
		<tr bgcolor='".TMPL_tblDataColor2."'><td><input type=submit name='closetoken' value='Close Query &raquo;'</td></tr>
		<tr bgcolor='".TMPL_tblDataColor1."'><td><input type=button value='Send query to other User/Team &raquo;' onclick='openwindow(\"tokens-pass.php?id=$id\")'></td></tr>
		</table>
		</td>
