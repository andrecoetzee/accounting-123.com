...
function printCat ($HTTP_POST_VARS)
{
	...
	if (pg_numrows ($docRslt) < 1) {
		...
		<tr class='even'><td><a href='doc-add.php'>Add Document</a></td></tr>
		<tr class='even'><td><a href='doc-view.php'>View Documents</a></td></tr>
		<tr class='even'><td><a href='../main.php'>Main Menu</a></td></tr>
		</table>";
	}
	while($doc = pg_fetch_array ($docRslt)) {
		# Alternate bgcolor
		$class = ($i % 2) ? "odd" : "even";
		$printCat .= "<tr class='$class'>
			<td>$doc[typename]</td>
			<td>$doc[docref]</td>
			<td>$doc[docname]</td>
			<td>$doc[docdate]</td>
