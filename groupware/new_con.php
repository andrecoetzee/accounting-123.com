...
// 	$select_bfyear .= "</select>";
	...
	<tr class='odd'><td><a href='list_cons.php'>List contacts</a></td></tr>
	</table>";
...
function write_data ($_POST)
{
	...
	$write_data ="<table cellpadding='2' cellspacing='0' class='shtable'>
	...
	<table cellpadding='2' cellspacing='0' class='shtable'>
		<tr><th>Quick Links</th></tr>
		<tr class='odd'><td><a href='".SELF."'>Add another contact</a></td></tr>
        <tr class='odd'><td><a href='list_cons.php'>List Contacts</a></td></tr>
	</table>";
