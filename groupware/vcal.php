...
$OUTPUT = "
<h3>Time</h3>
From: ".date("Y-m-d H:i:s", $time_s)."<br>
To: ".date("Y-m-d H:i:s", $time_e)."<br>
<h3>Description:</h3>
".nl2br($de_msg)."<br>
<br>
<table width='100%'>
<tr>
	<td align=center><b>[ <a class=nav href='vcal_accept.php?$passon'>Accept</a> ]</b></td>
	<td align=center><b>[ <a class=nav href='vcal_decline.php?$passon'>Decline</a> ]</b></td>
</tr>
</table>";
