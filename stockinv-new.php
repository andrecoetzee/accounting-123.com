...
<tr bgcolor='".TMPL_tblDataColor1."'><td>Order Date</td><td valign=center><input type=text size=2 name=oday maxlength=2>-<input type=text size=2 name=omon maxlength=2 value='".date("m")."'>-<input type=text size=4 name=oyear maxlength=4 value='".date("Y")."'> DD-MM-YYYY</td></tr>
...
<tr bgcolor='".TMPL_tblDataColor1."'><td>Account paid</td><td valign=center>$paid</td></tr>
<tr bgcolor='".TMPL_tblDataColor2."'><td>Stock Account (ie. Stock)</td><td valign=center>$stockacc</td></tr>
...
<tr bgcolor='".TMPL_tblDataColor2."'><td width=70%>Customer Name</td><td valign=center>$cusname</td></tr>
<tr bgcolor='".TMPL_tblDataColor1."'><td valign=top>Customer Address</td><td valign=center>$addr1<br>$addr2<br>$addr3</td></tr>
<tr bgcolor='".TMPL_tblDataColor2."'><td valign=top>Customer Postal Address</td><td valign=center>$paddr1<br>$paddr2<br>$paddr3</td></tr>
