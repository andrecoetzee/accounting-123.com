...
function printCat ()
{
	...
	while($typ = pg_fetch_array ($typRslt)) {
		...
		$printTyp .= "<tr bgcolor='$bgColor'><td>$typ[typeref]</td><td>$typ[typename]</td><!--<td><a href='doctypeedit.php?typeid=$typ[typeid]'>Edit</a></td>-->";
		$printTyp .= "<td><a href='doctyperem.php?typeid=$typ[typeid]'>Remove</a></td></tr>";
		$i++;
	}
	...
	<table border=0 cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."' width=15%>
		...
		<tr bgcolor='".TMPL_tblDataColor1."'><td><a href='doctypeadd.php'>Add Document type</a></td></tr>
