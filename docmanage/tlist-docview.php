...
function viewDoc ()
{
	...
	while ($docid = pg_fetch_array ($docRslt)) {
		...
		$documents .= "<tr bgcolor='$bgColor'><td>$docid[docid]</td><td>$i</td><td>$docid[typeid]</td><td>$docid[typename]</td><td>$docid[filename]</td><td><a href='tlistedit.php?docid=$docid[docid]'>Edit</a></td><td nowrap><a href='tlistrem.php?docid=$docid[docid]'>Permanetly Deleted</a></td><td nowrap><a href='tlistres.php?docid=$docid[docid]'>Restore Documents</a></td></tr>\n";
