...
$OUTPUT = "
	...
	<tr class='bg-even'><td>Document Title</td><td><input type=text size=20 name=docname ></td></tr>
	<tr class='bg-odd'><td>Initial Group</td><td align=center>$Unit</td></tr>
	<tr class='bg-even'><td>Private</td><td align=center>$User</td></tr>
	<tr class='bg-odd'><td>Temp Document</td><td><input type=file size=20 name=doc></td></tr>
	<tr><td><br></td></tr>
