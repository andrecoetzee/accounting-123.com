...
function edit ($VARS = array(), $errors = "")
{
	...
	//new
	 db_conn('cubit');
   	# write to db
  	$S1 = "SELECT * FROM documents WHERE docid='$docid' AND docname = docname";
...
function write ($_POST)
{
	...
	if ( ! pglib_transaction("BEGIN") ) {
		return "<li class=err>Unable to edit doccument(TB)</li>";
	}

	$S1="SELECT * FROM documents WHERE docid='$docid'";
