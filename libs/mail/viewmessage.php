...
<script>
	...
	editArea.height = editCell.height
</script>
<table width=100% height=100% cellspacing=0 cellpadding=5>
<tr>
	<th align=center valign=middle colspan=2 style = 'background: #0d3b72;'>
		$msg_data[subject]
	</th>
</tr>
...
<th bgcolor=blue height=40 width=0% align=right valign=middle nowrap>
	$attachments
</th></tr>
<tr>
	<td align=left valign=top name=editCell id=editCell colspan=2 height=100%>
		<iframe name='editArea' id='editArea' style='width: 100%; height: 100%; background: #FFFFFF;'></iframe>
	</td>
</tr>
</table>
";
