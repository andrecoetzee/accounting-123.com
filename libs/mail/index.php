...
<head><title>Cubit Mail</title></head>

<frameset rows='30,*' border=3>
	<frame name='msg_toolbar' src='toolbar.php' noresize scrolling=no>
	<frameset cols='175,*' border=3>
		<frame name=tree src='tree.php'>
		<frame name=rightframe src='messages.php'>
	</frameset>
</frameset>
