...
function edit($catid)
{
		...
		<tr bgcolor='".TMPL_tblDataColor1."'><td>Category code</td><td><input type=text size=20 name='catcod' value='$catcod'></td></tr>
		<tr bgcolor='".TMPL_tblDataColor2."'><td>Category name</td></td><td><input type=text size=20 name='cat' value='$cat'></td></tr>
		<tr bgcolor='".TMPL_tblDataColor1."'><td valign=top>Description</td><td><textarea cols=18 rows=5 name='descript'>$descript</textarea></td></tr>
...
function write($_POST)
{
	...
	<table border=0 cellpadding='2' cellspacing='1'>
		<tr><th>Quick Links</th></tr>
		<tr bgcolor='".TMPL_tblDataColor1."'><td><a href='stockcat-add.php'>Add Stock Category</a></td></tr>
		<tr bgcolor='".TMPL_tblDataColor2."'><td><a href='stockcat-view.php'>View Stock Categories</a></td></tr>
		<script>document.write(getQuicklinkSpecial());</script>
	</table>";
