...
function write($_POST)
{
	...
	if ($v->isError ()) {
		...
		<tr><td><br></td></tr>
		<tr class=datacell><td><form action='cust-stockinv-new.php' method=get><input type=hidden name=cusnum value='$cusnum'><input type=submit value='Continue to Invoice'></form></td></tr>
		</table>
        <p>
