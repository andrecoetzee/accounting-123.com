...
function write($HTTP_POST_VARS)
{
	...
	# Insert into stock
	db_connect();
	$sql = "UPDATE stock SET blocked = 'y' WHERE stkid = '$stkid' AND div = '".USER_DIV."'";
	$rslt = db_exec($sql) or errDie("Unable to insert stock to Cubit.",SELF);

	// Layout
	$write ="
	<table border=0 cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."' width='50%'>
	<tr><th>Stock item blocked</th></tr>
	<tr class=datacell><td>Stock item, <b>$stkdes ($stkcod)</b> has been successfully blocked.</td></tr>
	</table>
	<p>
