...
function confirm($_POST)
{
	...
	<tr><th>Field</th><th>Value</th></tr>
	<tr class='bg-odd'><td>Account Type</td><td>$acctype</td></tr>
	<tr class='bg-even'><td>Bank Name</td><td>$bankname</td></tr>
	<tr class='bg-odd'><td>Type</td><td>$locs[$loc]</td></tr>
	<tr class='bg-even'><td>Currency</td><td>$curr[symbol] - $curr[name]</td></tr>
	<tr class='bg-odd'><td>Branch Name</td><td>$branchname</td></tr>
	<tr class='bg-even'><td>Branch Code</td><td>$branchcode</td></tr>
	<tr class='bg-odd'><td>Account Name</td><td>$accname</td></tr>
	<tr class='bg-even'><td>Account Number</td><td>$accnum</td></tr>
	<tr class='bg-even'><td>Card Number</td><td>$cardnum</td></tr>
	<tr class='bg-odd'><td>Expiry Date</td><td>$mon-$year</td></tr>
	<tr class='bg-even'><td>Last 3 Digits at back of Card</td><td>$lastdigits</td></tr>
	<tr class='bg-odd'><td>Card Type</td><td>$cardtyp</td>
	<tr class='bg-odd'><td>Legder account</td><td>$glaccname</td></tr>
...
function write($_POST)
{
	...
	db_connect();
	$sql = "UPDATE bankacct SET acctype = '$acctype', bankname = '$bankname', btype = '$loc', fcid = '$fcid', currency = '$curr[name]', branchname='$branchname', branchcode='$branchcode', accname='$accname', accnum='$accnum', details='$details',
