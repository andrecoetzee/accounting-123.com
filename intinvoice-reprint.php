...
function details($HTTP_GET_VARS)
{
	...
	while($stkd = pg_fetch_array($stkdRslt)){
		...
		# Put in product
		$products .="<tr valign=top><td>$stk[stkcod]</td><td>$ex $sp $stk[stkdes]</td><td>$stkd[qty]</td><td>$stkd[unitcost]</td><td>$inv[currency] $stkd[disc]</td><td>$inv[currency] $stkd[amt]</td></tr>";
	}
