...
function viewcash($_POST)
{
	...
	if ($numrows < 1) {
		...
		# print the total
		$OUTPUT .= "<tr bgcolor='".TMPL_tblDataColor2 ."'><td colspan=6><b>Total Receipts</b></td><td><b>".CUR." ".sprintf("%01.2f",$rtotal)."</b></td></tr>";
	}
	...
	if ($numrows < 1) {
		$OUTPUT .= "<tr><td colspan=7 align=center><li class=err>There are no Payments made on the selected period.</td></tr>";
			...
			# print the total
			$OUTPUT .= "<tr bgcolor='".TMPL_tblDataColor2 ."'><td colspan=6><b>Total Payments</b></td><td><b>".CUR." ".sprintf("%01.2f",$ptotal)."</b></td></tr>";
	}
