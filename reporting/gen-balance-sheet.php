	...
	function getReport(){
		...
		while ($sub = pg_fetch_array($subRslt)) {
			...
			while($grp = pg_fetch_array($grpRslt)){
				$grpbal = sprint(0);
				$products .="<tr class='bg-odd'><td> <br> </td><td colspan=2><b>$grp[grpname]<b></td>";
			...
			$products .="</tr>";
			$products .="<tr class='bg-even'><td colspan=3><br></td><td align=right class=tot><b>$subbal</b></td></tr>";
		}
		if($typ == 'oe') $products .="<tr class='bg-even'><td colspan=2><b><u>Nett Income</u></b></td><td></td><td align=right>$nettincome</td><tr>";
