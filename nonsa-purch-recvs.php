...
/* --- Start Products Display --- */
	...
	while($stkd = pg_fetch_array($stkdRslt)){
		...
		# put in product
		$products .="<tr bgcolor='".TMPL_tblDataColor1."'><td><input type=hidden size=4 name=cod[] value='$stkd[cod]'>$stkd[cod]</td><td>$stkd[des]</td><td><input type=hidden name=qts[] value='$stkd[qty]'><input type=hidden size=5 name=qtys[] value='$stkd[qty]'>$stkd[qty]</td><td><input type=hidden size=4 name=unitcost[] value='$stkd[unitcost]'>$stkd[unitcost]</td><td>$sday-$smon-$syear</td><td>".CUR." $stkd[amt]</td></tr>";
		$key++;
	}
...
/* End moving purchase received */
	...
	<table border=0 cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."'>
		...
		<tr bgcolor='".TMPL_tblDataColor2."'><td>Non-Stock Asset Purchase receipt has been recorded.</td></tr>
	</table>
	<p>
	<table border=0 cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."'>
