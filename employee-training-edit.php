...
function get_training ($err = "")
{
	...
	$enterEmp = "
			...
			<form action='".SELF."' method=post>
				...
				<tr class='bg-odd'><td colspan='2'><input type='text' size='4' name='date_year' maxlength='4' value='$date_year'>-<input type='text' size='2' name='date_month' maxlength='2'  value='$date_month'>-<input type='text' size='2' name='date_day' maxlength='2' value='$date_day'></td></tr>
				<tr><th colspan='2'>Add Name of Course or Qualification</th></tr>
				<tr class='bg-odd'><td colspan='2'><textarea name=course_name cols='40' rows='4'>$course_name</textarea></td></tr>
				<tr class='bg-odd'><td>Date Commenced: </td><td><input type='text' size='4' name='commence_year' maxlength='4' value='$commence_year'>-<input type='text' size='2' name='commence_month' maxlength='2' value='$commence_month'>-<input type='text' size='2' name='commence_day' maxlength='2' value='$commence_day'></td></tr>
				<tr class='bg-even'><td>Date Completed: </td><td><input type='text' size='4' name='completed_year' maxlength='4' value='$completed_year'>-<input type='text' size='2' name='completed_month' maxlength='2' value='$completed_month'>-<input type='text' size='2' name='completed_day' maxlength='2' value='$completed_day'></td></tr>
				<tr class='bg-odd'><td>Select Training Provider: </td><td>$provider_list</td></tr>
				<tr class='bg-even'><td>Name of Assessor: </td><td><input type='text' name='assessor_name' value='$assessor_name'></td></tr>
				<tr class='bg-odd'><td>Cost of training: </td><td><input type='text' name='training_cost' value='$training_cost'></td></tr>
				<tr class='bg-even'><td>Individual competent date: </td><td><input type='text' size='4' name='competent_year' maxlength='4' value='$competent_year'>-<input type='text' size='2' name='competent_month' maxlength='2' value='$competent_month'>-<input type='text' size='2' name='competent_day' maxlength='2' value='$competent_day'></td></tr>
				<tr class='bg-odd'><th colspan='2'>Other Details: </th></tr>
				<tr class='bg-even'><td colspan='2'><textarea name='other_details' cols='40' rows='4'>$other_details</textarea></td></tr>
				<tr><td><br></td></tr>
