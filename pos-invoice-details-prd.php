...
# decide what to do
if (isset($HTTP_GET_VARS["invid"]) && isset($HTTP_GET_VARS["prd"])) {
						...
						<tr>
							<td valign='top'>
								<table ".TMPL_tblDflts." width='60%'>
									...
									<tr bgcolor='".bgcolorg()."'><td valign='top'>Customer Address</td><td valign='center'>".nl2br($inv['cusaddr'])."</td></tr>
									<tr bgcolor='".bgcolorg()."'><td>Customer Order number</td><td valign='center'>$inv[cordno]</td></tr>
									<tr bgcolor='".bgcolorg()."'><td>Customer Vat Number</td><td>$inv[cusvatno]</td></tr>
									<tr><th colspan='2' valign='top'>Comments</th></tr>
									<tr bgcolor='".bgcolorg()."'><td colspan='2' align='center'>".nl2br($inv['comm'])."</pre></td></tr>
								</table>
							</td>
						...
						<tr>
							<td>
								<table ".TMPL_tblDflts.">
									...
									<tr bgcolor='".bgcolorg()."'>
										<td><a href='pos-invoice-new.php'>New Invoice</a></td>
									</tr>
									<tr bgcolor='".bgcolorg()."'>
										<td><a href='pos-invoice-list.php'>View Invoices</a></td>
									</tr>
