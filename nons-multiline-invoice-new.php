...
function create_dummy($deptid, $ctyp, $tval,$acc)
{
	...
	$sql = "
		INSERT INTO nons_invoices (
			cusname, cusaddr, cusvatno, chrgvat, sdate, odate, subtot, balance, vat, total, done, username, 
			prd, invnum, typ, ctyp, tval, div, accid, multiline
		) VALUES (
			'', '', '', 'yes', CURRENT_DATE, '$odate', 0, 0, 0, 0, 'n', '".USER_NAME."', 
			'".PRD_DB."', 0, 'inv', '$ctyp', '$tval', '".USER_DIV."','$acc', 'yes'
		)";
