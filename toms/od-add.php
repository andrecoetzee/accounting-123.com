...
function enter ()
{
	...
	<tr class='bg-odd'><td><font class='required'>*</font>Overdue Term(days)</td><td align=center><input type=text size=20 name=days></td></tr>
...
function confirm ($_POST)
{
	...
	<tr><th>Field</th><th>Value</th></tr>
	<tr class='bg-odd'><td>Overdue Term</td><td align=center>$days</td></tr>
