...
function rem($id)
{
	...
	$enter =
	"<h3>Confirm Remove Overdue Term</h3>
...
function write ($HTTP_POST_VARS)
{
	...
	# write to db
	$sql = "DELETE FROM od WHERE id = '$id' AND div = '".USER_DIV."'";
	$catRslt = db_exec ($sql) or errDie ("Unable to remove term from system.", SELF);
	if (pg_cmdtuples ($catRslt) < 1) {
		return "<li class=err>Unable to remove Overdue term from database.";
	}

	$write =
	"<table border=0 cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."' width='50%'>
	<tr><th>Overdue Term Removed</th></tr>
	<tr class=datacell><td>Overdue term has been removed.</td></tr>
	</table>
	<p>
	<table border=0 cellpadding='2' cellspacing='1'>
	<tr><th>Quick Links</th></tr>
