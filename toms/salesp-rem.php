...
function rem($salespid)
{
	...
	<tr class='bg-odd'><td>Number</td><td>$salesp[salespno]</td></tr>
	<tr class='bg-even'><td>Sales Person</td><td>$salesp[salesp]</td></tr>
	<tr><td><br></td></tr>
	...
	<tr class='bg-odd'><td><a href='salesp-view.php'>View Sales Person</a></td></tr>
