...
function enter ()
{
	...
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Acc No</td><td><input type=text size=10 name=accno></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Surname/Company</td><td><input type=text size=20 name=surname></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Title</td><td><input type=text size=5 name=title></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Initials</td><td><input type=text size=10 name=init></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>First Name</td><td><input type=text size=20 name=firstname></td></tr>
	...
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Postal Address</td><td><textarea rows=5 cols=18 name=paddr></textarea></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Delivery Address</td><td><textarea rows=5 cols=18 name=daddr></textarea></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Contact Name</td><td><input type=text size=20 name=contname></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Business Tel.</td><td><input type=text size=20 name=bustel></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Home Tel.</td><td><input type=text size=20 name=hometel></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Cell No.</td><td><input type=text size=20 name=cellno></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Fax No.</td><td><input type=text size=20 name=faxno></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>E-mail</td><td><input type=text size=20 name=email></td></tr>
	...
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Trade Discount</td><td><input type=text size=20 name=traddisc></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Settlement Discount</td><td><input type=text size=20 name=setdisc></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Price List</td><td>$pricelists</td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Charge Interest</td><td><input type=text size=20 name=chrgint></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Overdue</td><td><input type=text size=20 name=overdue></td></tr>
	...
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Account Open Date</td><td><input type=text size=2 name=oday maxlength=2 value='".date("d")."'>-<input type=text size=2 name=omon maxlength=2 value='".date("m")."'>-<input type=text size=4 name=oyear maxlength=4 value='".date("Y")."'></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Credit Term</td><td><input type=text size=20 name=credterm></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Credit Limit</td><td><input type=text size=20 name=credlimit></td></tr>
...
function enter_err ($HTTP_POST_VARS, $err="")
{
	...
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Charge Vat</td><td><input type=text size=20 name=chrgvat value='$chrgvat'></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td colspan=2 align=center>Vat : Inclusive<input type=radio size=20 name=vatinc value=yes checked=yes> Exclusive<input type=radio size=20 name=vatinc value=no></td></tr>
	<tr bgcolor='".TMPL_tblDataColor1."'><td>Account Open Date</td><td><input type=text size=2 name=oday maxlength=2 value='".date("d")."'>-<input type=text size=2 name=omon maxlength=2 value='".date("m")."'>-<input type=text size=4 name=oyear maxlength=4 value='".date("Y")."'></td></tr>
