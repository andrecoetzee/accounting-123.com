...
function details($_GET)
{
	...
	<table cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."' border=0>
		...
		<tr class='bg-odd'><td><a href='pos-quote-canc-view.php'>View Cancelled POS Quotes</td></tr>
		<tr class='bg-odd'><td><a href='pos-quote-unf-view.php'>View Incomplete POS Quotes</td></tr>
