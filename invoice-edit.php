	...
	if(isset($whidss)){
		foreach($whidss as $key => $whid){
			if(isset($stkidss[$key]) && $stkidss[$key] != "-S"){
				...
				if(!isset($diffwhBtn)){
					...
					$products .="<tr bgcolor='".TMPL_tblDataColor1."'><td><input type=hidden name=whidss[] value='$whid'>$wh[whname]</td><td>$stks</td><td> </td><td><input type=text size=4 name='qtyss[]'  value='1'></td><td> </td><td><input type=text size=4 name=discs[] value='0'> OR <input type=text size=4 name=discps[] value='0' maxlength=5>%</td><td><input type=hidden name=amts[] value='0.00'>".CUR." 0.00</td><td></td></tr>";
				}
			}
		}
	}else{
		if(!isset($diffwhBtn)){
			...
			if (pg_numrows ($Rslt) > 0) {
				...
				$stks .= "</select> ";
				$products .= "<tr bgcolor='".TMPL_tblDataColor1."'><td><input type=hidden name=whidss[] value='$whid'>$wh[whname]</td><td>$stks</td><td> </td><td><input type=text size=4 name=qtyss[] value='1'></td><td> </td><td><input type=text size=4 name=discs[] value='0'> OR <input type=text size=4 name=discps[] value='0' maxlength=5>%</td><td>".CUR." 0.00</td><td></td></tr>";
			}else{
...
/* -- Final Layout -- */
	...
	<table cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."' border=0 width=95%>
 	<tr><td valign=top>
		...
		<table cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."' border=0>
			...
			<tr bgcolor='".TMPL_tblDataColor2."'><td>Invoice No.</td><td valign=center>TI $inv[invid]</td></tr>
			...
			<tr bgcolor='".TMPL_tblDataColor2."'><td>VAT Inclusive</td><td valign=center>Yes <input type=radio size=7 name=chrgvat value='inc' $chin> No<input type=radio size=7 name=chrgvat value='exc' $chex> No Vat<input type=radio size=7 name=chrgvat value='nov' $chno></td></tr>
			...
			<tr bgcolor='".TMPL_tblDataColor1."'><td>Invoice Date</td><td valign=center><input type=text size=2 name=oday maxlength=2 value='$oday'>-<input type=text size=2 name=omon maxlength=2 value='$omon'>-<input type=text size=4 name=oyear maxlength=4 value='$oyear'> DD-MM-YYYY</td></tr>
	...
	<tr><td>
		...
		<table border=0 cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."'>
			...
			<tr><td bgcolor='".TMPL_tblDataColor1."'><a href='cust-credit-stockinv.php'>New Invoice</a><td bgcolor='".TMPL_tblDataColor1."' rowspan=4 align=center valign=top><textarea name=comm rows=4 cols=20>$inv[comm]</textarea></td></tr>
