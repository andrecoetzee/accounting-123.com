...
function view($cusnum)
{
	...
	$view = "
		...
		<tr class='bg-even'><td>Terms</td><td valign=center><input type=text size=10 name=terms> days</td></tr>
...
function details($_POST)
{
	...
	if ($v->isError ()) {
		...
		while ($stk = pg_fetch_array ($stkRslt)) {
				$view .= "<tr class='bg-even'><td align=center><input type=checkbox name=sel[] value='$stk[stkid]'></td><td>$stk[stkdes]</td>
