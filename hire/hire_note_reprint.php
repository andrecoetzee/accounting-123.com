...
//	}
	...
	# Calculate subtotal
	$VATP = TAX_VAT;
	$SUBTOT = sprint($subtotal+$inv["delchrg"]);
	$VAT = sprint($SUBTOT*0.14);
...
function cash_receipt()
{
	...
	$sql = "UPDATE hire.reprint_invoices SET deposit_amt='0' WHERE invid='$invid'";
