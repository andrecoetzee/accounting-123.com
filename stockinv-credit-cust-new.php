...
function view($cusname="", $addr1="", $addr2="", $addr3="",  $paddr1="", $paddr2="", $paddr3="", $tel="", $fax="", $email="", $err="")
{
        ...
        $err
                ...
                <tr class='bg-even'><td rowspan=3 valign=top>Customer Delivery Address</td><td valign=center><input type=text size=20 name=addr1 value='$addr1'></td></tr>
...
function confirm($_POST)
{
	...
	if ($v->isError ()) {
        ...
        <input type=hidden name=email value='$email'>
                ...
                <tr class='bg-even'><td valign=top>Customer Delivery Address</td><td valign=center>$addr1<br>$addr2<br>$addr3</td></tr>
                <tr class='bg-odd'><td valign=top>Customer Postal Address</td><td valign=center>$paddr1<br>$paddr2<br>$paddr3</td></tr>
...
function write($_POST)
{
	...
	if ($v->isError ()) {
		...
		<tr><td><br></td></tr>
		<tr class=datacell><td><form action='cust-credit-stockinv.php' method=get><input type=hidden name=cusnum value='$cusnum'><input type=submit value='Continue to Invoice'></form></td></tr>
		</table>
        <p>
