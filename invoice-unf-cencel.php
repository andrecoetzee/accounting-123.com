...
function details($_GET)
{
	...
	<tr><td valign=top>
		<table cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."' border=0 width=40%>
			...
			<tr class='bg-even'><td>Customer</td><td valign=center>$cust[cusname] $cust[surname]</td></tr>
			<tr class='bg-odd'><td valign=top>Customer Address</td><td valign=center>".nl2br($cust['addr1'])."</td></tr>
			<tr class='bg-even'><td>Customer Order number</td><td valign=center>$quo[cordno]</td></tr>
