...
/* -- Final PDF output layout -- */
	...
	# just a new line
	$pdf->ezText("<b>Sales Order<b>", $set_txtSize+3, array('justification'=>'centre'));
	...
	$quodet[] = array('tit' => 'Sales Order No.', 'val' => $quo['invid']);
	$quodet[] = array('tit' => 'Sales Order Date', 'val' => $quo['odate']);
