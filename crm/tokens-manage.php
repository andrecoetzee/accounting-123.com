...
function manage($HTTP_POST_VARS,$Notes="") {
	...
	$cats="<select name=cat style='width: 100%'>";
	...
	$qteams="<select name=qteam style='width: 100%'>";
	...
	// If we don't have a Subject/Summary yet, give it a default value
	if (empty($tokendata["sub"])) {
		$tokendata["sub"] = "Telephone call";
	}
	...
	<tr>
		...
		<tr><td><br></td></tr>
			<tr>
				<td align='center'>
					<input type=button value='Todo List' onclick='openwindow(\"../todo.php\")'>
					<input type=button value='View Diary' onclick='openwindowbg(\"../diary/diary-index.php\")'>
				</td>
			</tr>
		</table>
		</td>
		...
		<tr>
			<td colspan=2 align=center>
				<input type=submit value='Update Query Information &raquo;'
