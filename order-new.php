...
function details($_POST)
{
	...
	if ($v->isError ()) {
		...
		<table border=0 cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."' width=300>
			...
			<tr class='bg-odd'><td>Supplier</td><td><input type=text size=20 name='supplier'></td></tr>
			<tr class='bg-even'><td>Tel No.</td><td><input type=text size=14 name='suptel'></td></tr>
			<tr class='bg-odd'><td>Fax No.</td><td><input type=text size=14 name='supfax'></td></tr>
			<tr class='bg-even'><td valign=top>Address</td><td><textarea rows=5 cols=18 name='addr'></textarea></td></tr>
			<tr class='bg-odd'><td>Order Date</td><td valign=center><input type=text size=2 name=oday maxlength=2 value='".date("d")."'>-<input type=text size=2 name=omon maxlength=2 value='".date("m")."'>-<input type=text size=4 name=oyear maxlength=4 value='".date("Y")."'> DD-MM-YYYY</td></tr>
			<tr class='bg-even'><td>Delivery Date</td><td valign=center><input type=text size=2 name=dday maxlength=2 value=''>-<input type=text size=2 name=dmon maxlength=2 value='".date("m")."'>-<input type=text size=4 name=dyear maxlength=4 value='".date("Y")."'> DD-MM-YYYY</td></tr>
			<tr class='bg-odd'><td>Buying units</td><td><input type=text size=10 name='buom'> x $stk[buom]</td></tr>
			<tr class='bg-even'><td>Selling units</td><td><input type=text size=10 name='suom'> x $stk[suom]</td></tr>
			<tr class='bg-odd'><td>Cost Amount</td><td>".CUR." <input type=text size=9 name='csamt'></td></tr>
...
function confirm($_POST)
{
		...
		<table border=0 cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."' width=300>
			...
			<tr class='bg-even'><td>Tel No.</td><td>$suptel</td></tr>
			<tr class='bg-odd'><td>Fax No.</td><td>$supfax</td></tr>
			<tr class='bg-even'><td valign=top>Address</td><td><pre>$addr</pre></td></tr>
			<tr class='bg-odd'><td>Order Date</td><td>$odate</td></tr>
