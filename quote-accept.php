...
function details($_GET)
{
	...
	<tr><td valign=top>
		<table cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."' border=0 width=40%>
			...
			<tr class='bg-odd'><td>Customer Vat Number</td><td>$quo[cusvatno]</td></tr>
...
pglib_transaction ("COMMIT") or errDie("Unable to commit a database transaction.",SELF);
	...
	<table border=0 cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."'>
		...
		<tr class='bg-even'><td>Quote for customer <b>$quo[cusname] $quo[surname]</b> has been accepted</td></tr>
	</table>
	<p>
	<table border=0 cellpadding='".TMPL_tblCellPadding."' cellspacing='".TMPL_tblCellSpacing."'>
		<tr><th>Quick Links</th></tr>
