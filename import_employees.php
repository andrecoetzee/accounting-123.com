...
function get_file_location ($err="")
{
	...
	$display = "
					<h2>Import Monthly Employees</h2>
					$err
					<table ".TMPL_tblDflts.">
					<form action='".SELF."' method='POST' enctype='multipart/form-data'>
						...
						<tr>
							<td><li class='err'>Empoyee Number|Cost Center|Surname|First Name|ID Number|Passport Number|Birthdate|Sex|Race|Disabled (Y/N)|Status|Resident (Y/N)|Bank Name|Branch|Bank Account Type|Bank Account Number|Residential 1|Residential 2|Residential 3|Postal 1|Postal 2|Postal 3|Postal Code|Upl Image (Y/N)|Annual Remuneration|Pay Type|Hours Per Week|Income Tax Reference|Starting Date (xx/xx/xx)|Termination Date|Temp. Emp (Y/N)|If Temp. Termination Date|Job Title|Department|Occupation Category|Occupation Level|This Position Filled|Recruitment From|Reason For Employment|Union Name|Union Member Number|Union Position|Leave Days</li></td>
						</tr>
						".TBL_BR."
						<tr>
