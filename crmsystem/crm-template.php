...
if (basename (getenv ("SCRIPT_NAME")) == "crm-template.php") {
	die("Invalid use of module");
}

$OUTPUT = "
<table width='100%'>
<tr>
	<td width=0% align=left valign=top>".shortcuts()."</td>
	<td width=100% align=center valign=top>$OUTPUT</td>
</tr>
</table>";

relative_require("template.php");
