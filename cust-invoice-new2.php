...
function view($cusnum)
{
		...
		<tr class='bg-even'><td>Bank Account Paid to</td><td valign=center>$bank</td></tr>
		<tr class='bg-odd'><td>Stock Account (ie. Stock)</td><td valign=center>$stockacc</td></tr>
...
function confirm($_POST)
{
		...
		<tr class='bg-even'><td>Bank Account Paid to</td><td valign=center>$bank[accname]</td></tr>
